...
<body>
    <?php if($_POST){ ?>
        ...
        <p>La serie que mas te gusta es: <strong><?php echo $lsSerie; ?></strong></p>
        <p><strong>Tu mensaje es: </strong><?php echo $txtComentario; ?></p><br>
    <?php } ?>
    <div>
        <form action="05_valores-textarea.php" method="post">
            ...
            <span>¿Algún mensaje para compartir?...</span><br>
